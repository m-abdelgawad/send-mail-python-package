...
<div align="center">
  ...
  <h3 align="center">Send Mail With SMTP Python Package</h3>
...
* Project Name: Send Mail With SMTP Python Package
* Version: v1.0.0
...
- [x] Clean code and good documentation.
- [x] Include multiple recipients.
- [x] Include multiple CCs.
- [x] HTML formatted mail messages.
- [x] Include multiple attachments.
